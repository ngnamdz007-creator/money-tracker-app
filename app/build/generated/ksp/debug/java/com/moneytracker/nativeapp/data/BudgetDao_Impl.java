...
public final class BudgetDao_Impl implements BudgetDao {
      ...
      public List<Budget> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final BudgetPeriod _tmp_3 = __converters.toBudgetPeriod(_tmp_2);
            if (_tmp_3 == null) {
              throw new IllegalStateException("Expected NON-NULL 'com.moneytracker.nativeapp.data.BudgetPeriod', but it was NULL.");
            } else {
              _tmpPeriod = _tmp_3;
            }
            ...
            if (_cursor.isNull(_cursorIndexOfEndDate)) {
              ...
              _tmp_6 = _cursor.getString(_cursorIndexOfEndDate);
            }
  ...
  @Override
  public Object getOverallBudget(final Continuation<? super Budget> $completion) {
