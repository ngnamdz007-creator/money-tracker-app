...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView btnDelete,
      @NonNull ImageView btnEdit, @NonNull ImageView ivIcon, @NonNull TextView tvName) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((LinearLayout) rootView, btnDelete, btnEdit, ivIcon, tvName);
    }
