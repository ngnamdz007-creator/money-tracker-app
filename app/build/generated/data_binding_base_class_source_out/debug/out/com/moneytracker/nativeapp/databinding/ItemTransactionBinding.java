...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull CardView rootView, @NonNull ImageView ivIcon,
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionBinding((CardView) rootView, ivIcon, tvAmount, tvCategory, tvDate,
          tvTitle);
    }
