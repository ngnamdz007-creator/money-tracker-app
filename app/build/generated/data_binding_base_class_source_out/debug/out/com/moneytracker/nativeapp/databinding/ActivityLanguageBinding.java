...
public final class ActivityLanguageBinding implements ViewBinding {
  ...
  private ActivityLanguageBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnSave,
      @NonNull RadioGroup radioGroupLanguage, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityLanguageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLanguageBinding((LinearLayout) rootView, btnSave, radioGroupLanguage,
          toolbar);
    }
